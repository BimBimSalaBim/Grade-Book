...
public class EditAddAssignment extends JFrame 
{
	...
	{
		EditAddAssignment frame = new EditAddAssignment();
	 ...
	 * Create the frame.
	 */
	public EditAddAssignment() //constructor
	{
		setResizable(false);
	...
	lblWelcome.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 24));
		...
		JButton btnAddClass = new JButton("Add New Assiagnment");
		btnAddClass.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					Main.list.setSelectedValue(Main.SelectedTab, true);
